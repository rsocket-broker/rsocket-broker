...
public class BrokerAutoConfiguration implements InitializingBean {
	...
	public void afterPropertiesSet() {
		...
		if (metadataExtractor instanceof DefaultMetadataExtractor) {
			...
			// adds all BrokerFrame impls such as RouteJoin, RouteSetup, etc..
			// to the spring encoding/decoding framework.
			extractor.metadataToExtract(MimeTypes.BROKER_FRAME_MIME_TYPE, BrokerFrame.class,
					MimeTypes.BROKER_FRAME_METADATA_KEY);
		}
	}
